        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
            ...
            <p className="text-neon-blue">
              <strong>🤖 AI-Generated Content:</strong> These documents are created using artificial intelligence. 
              AI can make mistakes, so please review all generated content carefully before use.
            </p>
            <p className="text-neon-green">
              <strong>📄 PDF Customization:</strong> All documents are delivered as downloadable PDFs. 
              You can make your own custom changes to the PDFs after downloading them using any PDF editor.
            </p>
          </div>
        </div>
      </section>
